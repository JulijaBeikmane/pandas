...
class Customer(SystemUser):
    def __init__(self, username, password, email, customer_id, purchase_history, membership_status):
        ...
        # self.password = password
        # self.email = email
        super().__init__(username, password, email) #manto atribūutus no vecāka klases
    ...
    def get_user_info(self):
        ...
        print(f"Klienta vēsture: {self.purchase_history}")
...
#no 1. uzdevuma
produkts1 = Product("Apple", 0.7, 10)
produkts2 = Product("Banana", 0.4, 15)
...
liet1 = SystemUser("Kārli", "12345", "karlis@karlis.com")
